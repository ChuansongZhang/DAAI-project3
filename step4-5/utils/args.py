...
FW_TASKS = {
    ...
    'federated': ['oracle', 'source_only', 'fda', 'fda_inv']
}
SOURCE_DATASETS = ['gta5']
TARGET_DATASETS = ['cityscapes']
...
CL_TYPE = {
    'cityscapes': ['uniform', 'heterogeneous']
}

MODELS = {'cityscapes': ['bisenetv2','deeplabv3']}
...
def parse_args():
    ...
    parser.add_argument('--partition', type=str, choices=PARTITION, required=True, help='Partition of dataset')
    ...
    parser.add_argument('--sourceonly_loss', type=str, default='selftrain',
    ...
    parser.add_argument('--load_SourceOnly', action='store_true', default=False, help='Whether to use pretrained or not')
    parser.add_argument('--load_SourceOnly_id', type=str, default=None, help='wandb id to resume run')
    parser.add_argument('--load_SourceOnly_best', action='store_true', default=False,
