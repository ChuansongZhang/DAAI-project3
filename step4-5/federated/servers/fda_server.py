...
class FdaServer(Server):
    ...
    def save_pretrained_server(self, model_state, best: bool):
        ...
        torch.save(state, os.path.join(ckpt_path, 'pretrained_server{}_lr{}_fda_b{}.ckpt'.format("_best" if best else "", self.args.lr, self.args.fda_b)))
        self.writer.wandb.save(os.path.join(ckpt_path, 'pretrained_server{}_lr{}_fda_b{}.ckpt'.format("_best" if best else "", self.args.lr, self.args.fda_b)))
        print("Done.")
