...
class Client:
    ...
    def __init__(self, args, client_id, dataset, model, writer, batch_size, world_size, rank, num_gpu,
        ...
        if args.random_seed is None:
            ...
            self.loader_full = data.DataLoader(self.dataset, batch_size=1, drop_last=True)
        else :
            g = torch.Generator()
    ...
    def calc_loss_and_output(self, images, labels):
        ...
        elif self.args.model in ('bisenetv2', ):
            # print('-------images type--------')
            # print(type(images), images.shape)
            # if self.args.fw_task == 'fda_inv':
    ...
    def manage_tot_test_loss(self, tot_loss):
        ...
        return tot_loss / len(self.loader)
